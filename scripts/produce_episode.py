...
def main() -> int:
    ...
    # Use the bundled Claracle theme for both the intro and outro mix windows.
    ...
    manifest = {
        ...
        "operator_feedback_addressed": [
            ...
            "replaced the placeholder stingers with the Claracle theme music bed",
        ...
        "music": {
            "policy": "Claracle theme is reused for both intro and outro; see assets/music/ATTRIBUTION.md",
            "intro": {
