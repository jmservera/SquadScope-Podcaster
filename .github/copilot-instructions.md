...
- `zizmor .github/workflows/` when you change anything under `.github/workflows/`
  (all workflows, including the generated `squad-*`/`sync-squad-labels` files, are
  now scanned — their actions are SHA-pinned in-repo).
