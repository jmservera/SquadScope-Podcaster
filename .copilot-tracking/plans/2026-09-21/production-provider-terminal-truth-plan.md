...
| `PRRT_kwDOSzuis86kjsxn` / r4067399134 | [corrected evidence r4073299679](https://github.com/jmservera/SquadScope-Podcaster/pull/682#discussion_r4073299679) | Fixed at `d6e85ef`: missing, throwing, null, or incorrect size probes reject the checkpoint and retain the local source for recomputation; exact verified size succeeds. | Resolved; acceptance pending Rusty |
...
| `PRRT_kwDOSzuis86kpfCH` / r4069683559 | [corrected evidence r4073299841](https://github.com/jmservera/SquadScope-Podcaster/pull/682#discussion_r4073299841) | Fixed at `d6e85ef`: shared finalization stages output, requires positive-duration video and requested audio via ffprobe, atomically promotes only valid media, preserves an existing destination, and cleans failed staging. | Resolved; acceptance pending Rusty |
